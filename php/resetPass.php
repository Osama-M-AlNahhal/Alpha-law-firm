				...
				<div class="reset-container">
					...
					<form action="inc/handleReset.inc.php" class="reset-form" method="POST">
						...
						<div class="reset-info-text">
							...
							<p class="white-text font-normal ">سيتم ارسال ايميل يحتوي على ارشادات حول كيفية اعادة تعيين كلمة المرور الخاصة بك
							</p>
						</div>

						<div class="reset-info-input">
							<input type="text" name="email" placeholder="ادخل ايميلك
							">
						</div>
